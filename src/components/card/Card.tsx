      ...
      <div className="card">
        ...
        <div className="card__description">
          <div className="card__description__title">
            ...
            <IconSvg name="heart" className="card__description__title__bookmark"></IconSvg>
          </div>
        ...
        <div className="card__details">
          <div className="card__details__item">
            <IconSvg name="bed" className="card__details__item__svg"></IconSvg>
            <span className="card__details__item__title">{bedrooms}</span>Bedrooms
          </div>
          <div className="card__details__item">
            <IconSvg name="bath" className="card__details__item__svg"></IconSvg>
